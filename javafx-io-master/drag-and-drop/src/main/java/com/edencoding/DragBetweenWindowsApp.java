...
public class DragBetweenWindowsApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("images/prison_icon.png")));
        ...
        secondaryStage.getIcons().add(new Image(getClass().getResourceAsStream("images/prison_icon.png")));
